...
export default function WellSearchPicker({
  ...
  // Portal target — see FilterSelect for the iOS Safari overflow-containing-
  // block rationale. Tracked via state so SSR renders nothing on first pass.
  ...
  // Outside-click close handler was here previously — removed because the
  // portaled mobile sheet lives outside containerRef and would close on every
  // tap inside the sheet. The backdrop and Cancel button cover the close
  // intent on both mobile and desktop.
  ...
  return (
    <div className="relative">
      ...
      {open && (() => {
        ...
        return (
          <>
            {/* Mobile: portaled bottom sheet, matching FilterSelect's pattern.
                Portaling to document.body avoids the iOS Safari quirk where a
                fixed-position descendant of an overflow-y-auto ancestor gets
                trapped inside the scroll container. */}
