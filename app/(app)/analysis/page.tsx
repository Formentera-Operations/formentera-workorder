                    ...
                    <>
                      <ResponsiveContainer width="100%" height={320}>
                        <BarChart data={data} margin={{ top: 4, right: 4, left: 12, bottom: 50 }}>
                          ...
                          <Tooltip cursor={{ fill: '#F3F4F6' }} content={<ChartTooltip valueFormatter={fmt} />} position={{ y: 0 }} wrapperStyle={{ outline: 'none', zIndex: 50 }} />
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
              ...
              <ResponsiveContainer width="100%" height={180}>
                <BarChart data={monthlyTrend} margin={{ top: 4, right: 4, left: 12, bottom: 20 }}>
                  ...
                  />
                  <Tooltip cursor={{ fill: '#F3F4F6' }} content={<ChartTooltip valueFormatter={(v) => `${v} tickets`} />} position={{ y: 0 }} wrapperStyle={{ outline: 'none', zIndex: 50 }} />
